...
TRANSLATIONS = {
    'en': {
        ...
        'analysis_ai_analyzing': 'Our AI is analyzing your agricultural data. Please wait...',
        'analysis_step': 'Step',
        'analysis_of': 'of',
        'analysis_processing': 'Processing',
        'analysis_validating_files': 'Validating uploaded files...',
        'analysis_validating': 'Validating files...',
        'analysis_extracting_data': 'Extracting data from analysis reports...',
        'analysis_extracting_soil': 'Extracting soil data via OCR...',
        'analysis_extracting_leaf': 'Extracting leaf data via OCR...',
        'analysis_extraction_completed': 'Data extraction completed successfully',
        'analysis_processing_data': 'Processing extracted data...',
        'analysis_time_remaining': 'Estimated time remaining',
        'analysis_seconds': 'seconds',
        'analysis_running_ai': 'Running AI analysis...',
        'analysis_running_comprehensive': 'Running comprehensive agricultural analysis...',
        'analysis_processing_patterns': 'Processing data patterns and generating insights...',
        'analysis_ai_analysis': 'AI Analysis',
        'analysis_starting_comprehensive': 'Starting comprehensive AI analysis...',
        'analysis_may_take': 'This may take 2-5 minutes. Please keep this page open...',
        'analysis_processing_data_msg': 'Processing your data...',
        'analysis_analyzing_patterns': 'Analyzing patterns...',
        'analysis_generating_insights': 'Generating insights...',
        'analysis_computing_results': 'Computing results...',
        'analysis_optimizing': 'Optimizing analysis...',
        'analysis_finalizing': 'Finalizing report...',
        'analysis_almost_done': 'Almost done...',
    ...
    'ms': {
        ...
        # Analysis Progress Messages (Malaysian)
        'analysis_in_progress': 'Analisis Sedang Dijalankan',
        'analysis_ai_analyzing': 'AI kami sedang menganalisis data pertanian anda. Sila tunggu...',
        'analysis_step': 'Langkah',
        'analysis_of': 'daripada',
        'analysis_processing': 'Memproses',
        'analysis_validating_files': 'Mengesahkan fail yang dimuat naik...',
        'analysis_validating': 'Mengesahkan fail...',
        'analysis_extracting_data': 'Mengekstrak data dari laporan analisis...',
        'analysis_extracting_soil': 'Mengekstrak data tanah melalui OCR...',
        'analysis_extracting_leaf': 'Mengekstrak data daun melalui OCR...',
        'analysis_extraction_completed': 'Pengekstrakan data selesai dengan jayanya',
        'analysis_processing_data': 'Memproses data yang diekstrak...',
        'analysis_time_remaining': 'Anggaran masa yang tinggal',
        'analysis_seconds': 'saat',
        'analysis_running_ai': 'Menjalankan analisis AI...',
        'analysis_running_comprehensive': 'Menjalankan analisis pertanian komprehensif...',
        'analysis_processing_patterns': 'Memproses corak data dan menjana pandangan...',
        'analysis_ai_analysis': 'Analisis AI',
        'analysis_starting_comprehensive': 'Mula analisis AI komprehensif...',
        'analysis_may_take': 'Ini mungkin mengambil masa 2-5 minit. Sila biarkan halaman ini terbuka...',
        'analysis_processing_data_msg': 'Memproses data anda...',
        'analysis_analyzing_patterns': 'Menganalisis corak...',
        ...
        'analysis_generating_insights_recs': 'Menjana pandangan dan cadangan...',
        'analysis_creating_recommendations': 'Mewujudkan cadangan yang boleh dilaksanakan...',
        'analysis_insights': 'Pandangan',
