...
TRANSLATIONS = {
    'en': {
        ...
        'pdf_specific_recommendations': 'Specific Recommendations (Rates)',
        ...
        'pdf_year_1_economic_impact': 'Year-1 Economic Impact Forecast per Hectare',
        'pdf_metric': 'Metric',
        'pdf_value_label': 'Value',
        'pdf_estimated_cost_benefit': 'Estimated Cost-Benefit Analysis',
        'pdf_investment_level': 'Investment Level',
        'pdf_total_investment': 'Total Investment (RM)',
        'pdf_expected_return': 'Expected Return (RM)',
        'pdf_roi_percent': 'ROI (%)',
        'pdf_payback_period': 'Payback Period (Months)',
        ...
        'pdf_5_year_yield_projections': '5-Year Yield Projections',
        ...
        'pdf_total_references_found': 'Total References Found',
        'pdf_database_references': 'Database References',
        'pdf_raw_analysis_data': 'Raw Analysis Data',
        'pdf_soil_analysis_parameters': 'Soil Analysis Parameters',
        'pdf_leaf_analysis_parameters': 'Leaf Analysis Parameters',
        'pdf_no_raw_data': 'No raw data available for this analysis.',
        'pdf_data_analysis_results': 'Data Analysis Results',
    ...
    'ms': {
        ...
        'pdf_analysis_results': 'Hasil Analisis',
        'pdf_executive_summary_fallback': 'Ringkasan eksekutif tidak dapat dijana daripada data analisis.',
        'pdf_summary_error': 'Ringkasan tidak dapat dijana disebabkan masalah teknikal.',
        'pdf_analysis_completed': 'Analisis telah selesai dengan jayanya. Berikut adalah penemuan utama dan cadangan:',
        'pdf_based_on_analysis': 'Berdasarkan hasil analisis',
        'pdf_projected_yield_improvement': 'Peningkatan Hasil Dijangka',
        'pdf_with_proper_management': 'dengan pengurusan yang betul',
        'pdf_estimated_roi': 'ROI Anggaran',
        'pdf_over_years': 'lebih 3-5 tahun',
        'pdf_new_yield': 'Hasil Baru (t/ha)',
        'pdf_additional_yield': 'Hasil Tambahan (t/ha)',
        'pdf_additional_revenue': 'Pendapatan Tambahan (RM)',
        'pdf_cost_per_hectare': 'Kos Setiap Hektar (RM)',
        'pdf_payback_months': 'Pulangan Modal (bulan)',
        'pdf_roi_capped': 'Dihadkan untuk realisme - ROI maksimum yang mampan',
        'pdf_chart_generation_failed': 'Penjanaan carta gagal',
        'pdf_chart_generation_error': 'Ralat penjanaan carta',
        'pdf_conclusion_overview_text': 'Analisis pertanian komprehensif ini telah menilai secara sistematik status pemakanan semasa ladang kelapa sawit anda dan mengenal pasti kawasan kritikal untuk penambahbaikan. Analisis langkah demi langkah mendedahkan cabaran dan peluang khusus yang memberi kesan langsung kepada produktiviti dan keuntungan ladang anda.',
        'pdf_conclusion_findings_text': 'Analisis telah mengenal pasti beberapa faktor kritikal yang mempengaruhi prestasi ladang anda. Penemuan ini menyediakan peta jalan yang jelas untuk intervensi sasaran yang akan memaksimumkan pulangan pelaburan anda sambil memastikan amalan pertanian yang mampan.',
        'pdf_conclusion_economic_text': 'Analisis ekonomi menunjukkan potensi yang ketara untuk peningkatan keuntungan melalui intervensi strategik. Senario pelaburan yang dibentangkan menunjukkan laluan yang jelas untuk peningkatan hasil dan peningkatan pendapatan, dengan pendekatan pelaburan sederhana biasanya menawarkan keseimbangan optimum antara keberkesanan kos dan peningkatan hasil.',
        'pdf_conclusion_yield_text': 'Analisis ramalan hasil menyediakan peta jalan terperinci untuk pertumbuhan mampan selama lima tahun akan datang. Unjuran ini berdasarkan senario pelaburan yang realistik dan mengambil kira variasi bermusim, keadaan pasaran, dan garis masa pelaksanaan. Ramalan menunjukkan potensi untuk peningkatan hasil yang ketara dengan pengurusan yang betul dan intervensi sasaran.',
        'pdf_conclusion_implementation_text': 'Pelaksanaan yang berjaya bagi cadangan ini memerlukan pendekatan berperingkat, bermula dengan intervensi keutamaan tinggi dan secara beransur-ansur berkembang kepada amalan pengurusan komprehensif. Pemantauan berkala dan pengurusan adaptif akan penting untuk mencapai hasil yang diunjurkan dan memastikan kemampanan jangka panjang.',
        'pdf_conclusion_longterm_text': 'Analisis menunjukkan potensi yang kuat untuk peningkatan produktiviti yang berterusan dan peningkatan keuntungan. Dengan mengikuti strategi yang disyorkan dan mengekalkan amalan pemantauan yang konsisten, ladang anda boleh mencapai peningkatan hasil yang ketara sambil menyumbang kepada matlamat intensifikasi pertanian mampan. Unjuran 5 tahun menyediakan visi yang jelas untuk kejayaan jangka panjang dan pertumbuhan berterusan.',
        'pdf_conclusion_final_text': 'Analisis ini menyediakan asas komprehensif untuk mengoptimumkan prestasi ladang kelapa sawit anda. Gabungan penilaian pemakanan terperinci, analisis ekonomi, dan unjuran hasil menawarkan laluan yang jelas ke hadapan untuk mencapai peningkatan produktiviti dan keuntungan. Pelaksanaan strategi yang disyorkan akan meletakkan ladang anda untuk kejayaan mampan dan pertumbuhan jangka panjang.',
        'pdf_data_tables': 'Jadual Data',
        'pdf_analysis_date': 'Tarikh Analisis',
        'pdf_report_types': 'Jenis Laporan',
        'pdf_comprehensive_analysis_results': 'Hasil Analisis Komprehensif',
        ...
        'pdf_specific_recommendations': 'Cadangan Spesifik (Kadar)',
        'pdf_economic_impact_forecast': 'Ramalan Kesan Ekonomi',
        'pdf_current_yield': 'Hasil Semasa',
        'pdf_land_size': 'Saiz Tanah',
        'pdf_palm_density': 'Kepadatan Sawit',
        'pdf_total_palms': 'Jumlah Pokok Sawit',
        'pdf_ffb_price_range': 'Julat Harga FFB',
        'pdf_year_1_economic_impact': 'Ramalan Kesan Ekonomi Tahun-1 Setiap Hektar',
        'pdf_metric': 'Metrik',
        'pdf_value_label': 'Nilai',
        'pdf_estimated_cost_benefit': 'Analisis Kos-Faedah Anggaran',
        'pdf_investment_level': 'Tahap Pelaburan',
        'pdf_total_investment': 'Jumlah Pelaburan (RM)',
        'pdf_expected_return': 'Pulangan Dijangka (RM)',
        'pdf_roi_percent': 'ROI (%)',
        'pdf_payback_period': 'Tempoh Pulangan Modal (Bulan)',
        ...
        'pdf_5_year_yield_projections': 'Unjuran Hasil 5 Tahun',
        ...
        'pdf_total_references_found': 'Jumlah Rujukan Dijumpai',
        'pdf_database_references': 'Rujukan Pangkalan Data',
        'pdf_raw_analysis_data': 'Data Analisis Mentah',
        'pdf_soil_analysis_parameters': 'Parameter Analisis Tanah',
        'pdf_leaf_analysis_parameters': 'Parameter Analisis Daun',
        'pdf_no_raw_data': 'Tiada data mentah tersedia untuk analisis ini.',
