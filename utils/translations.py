...
TRANSLATIONS = {
    'en': {
        ...
        'upload_leaf_expected': 'Leaf analysis with N%, P%, K%, Mg%, Ca%, B, Cu, Zn content, etc.',
        ...
        'upload_land_size_help': 'Enter the total land area for analysis',
        'upload_current_yield': 'Current Yield',
        'upload_current_yield_help': 'Enter the current yield per unit area',
        'upload_yield_unit': 'Yield Unit',
        'upload_palm_density': 'Palm Density',
        'upload_palms_per_hectare': 'Palms per Hectare',
        'upload_palm_density_help': 'Number of oil palm trees per hectare (typical: 136-148)',
        ...
        'results_keep_page_open': 'Please keep this page open during analysis. The process may take 5-8 minutes.',
        ...
        'pdf_detailed_conclusion': 'Detailed Conclusion',
        'pdf_analysis_overview': 'Analysis Overview',
        'pdf_analysis_overview_text': "This comprehensive agricultural analysis has systematically evaluated your oil palm plantation's current nutritional status and identified critical areas for improvement. The step-by-step analysis reveals specific challenges and opportunities that directly impact your plantation's productivity and profitability.",
        'pdf_key_findings_summary': 'Key Findings Summary',
        'pdf_key_findings_summary_text': "The analysis has identified several critical factors affecting your plantation's performance. These findings provide a clear roadmap for targeted interventions that will maximize your return on investment while ensuring sustainable agricultural practices.",
        'pdf_economic_impact_assessment': 'Economic Impact Assessment',
        'pdf_economic_impact_text': 'The economic analysis demonstrates significant potential for improved profitability through strategic interventions. The investment scenarios presented show clear pathways to enhanced yields and increased revenue, with medium investment approaches typically offering the optimal balance between cost-effectiveness and yield improvement.',
        'pdf_yield_projections': '5-Year Yield Projections',
        'pdf_yield_projections_text': 'The yield forecast analysis provides a detailed roadmap for sustainable growth over the next five years. These projections are based on realistic investment scenarios and account for seasonal variations, market conditions, and implementation timelines. The forecast demonstrates the potential for substantial yield improvements with proper management and targeted interventions.',
        'pdf_implementation_strategy': 'Implementation Strategy',
        'pdf_implementation_strategy_text': 'Successful implementation of these recommendations requires a phased approach, beginning with high-priority interventions and gradually expanding to comprehensive management practices. Regular monitoring and adaptive management will be essential to achieving the projected outcomes and ensuring long-term sustainability.',
        'pdf_long_term_outlook': 'Long-term Outlook',
        'pdf_long_term_outlook_text': "The analysis indicates strong potential for sustained productivity improvements and enhanced profitability. By following the recommended strategies and maintaining consistent monitoring practices, your plantation can achieve significant yield increases while contributing to sustainable agricultural intensification goals. The 5-year projections provide a clear vision for long-term success and continued growth.",
        'pdf_final_summary': 'Final Summary',
        'pdf_final_summary_text': "This analysis provides a comprehensive foundation for optimizing your oil palm plantation's performance. The combination of detailed nutritional assessment, economic analysis, and yield projections offers a clear path forward for achieving improved productivity and profitability. Implementation of the recommended strategies will position your plantation for sustainable success and long-term growth.",
    ...
    'ms': {
        ...
        'upload_expected': 'Dijangka',
        'upload_leaf_expected': 'Analisis daun dengan N%, P%, K%, Mg%, Ca%, B, Cu, Zn kandungan, dll.',
        ...
        'upload_land_unit': 'Unit',
        'upload_land_size_help': 'Masukkan jumlah kawasan tanah untuk analisis',
        'upload_current_yield': 'Hasil Semasa',
        'upload_current_yield_help': 'Masukkan hasil semasa per unit kawasan',
        'upload_yield_unit': 'Unit Hasil',
        'upload_palm_density': 'Ketumpatan Kelapa Sawit',
        'upload_palms_per_hectare': 'Pokok Kelapa Sawit per Hektar',
        'upload_palm_density_help': 'Bilangan pokok kelapa sawit per hektar (biasa: 136-148)',
        ...
        'results_keep_page_open': 'Sila biarkan halaman ini terbuka semasa analisis. Proses ini mungkin mengambil masa 5-8 minit.',
        ...
        'pdf_detailed_conclusion': 'Kesimpulan Terperinci',
        'pdf_analysis_overview': 'Gambaran Keseluruhan Analisis',
        'pdf_analysis_overview_text': 'Analisis pertanian komprehensif ini telah menilai secara sistematik status pemakanan semasa ladang kelapa sawit anda dan mengenal pasti bidang kritikal untuk penambahbaikan. Analisis langkah demi langkah mendedahkan cabaran dan peluang khusus yang memberi kesan langsung kepada produktiviti dan keuntungan ladang anda.',
        'pdf_key_findings_summary': 'Ringkasan Penemuan Utama',
        'pdf_key_findings_summary_text': 'Analisis telah mengenal pasti beberapa faktor kritikal yang mempengaruhi prestasi ladang anda. Penemuan ini menyediakan peta jalan yang jelas untuk campur tangan yang disasarkan yang akan memaksimumkan pulangan pelaburan sambil memastikan amalan pertanian yang mampan.',
        'pdf_economic_impact_assessment': 'Penilaian Kesan Ekonomi',
        'pdf_economic_impact_text': 'Analisis ekonomi menunjukkan potensi yang ketara untuk peningkatan keuntungan melalui campur tangan strategik. Senario pelaburan yang dibentangkan menunjukkan laluan yang jelas untuk peningkatan hasil dan peningkatan pendapatan, dengan pendekatan pelaburan sederhana biasanya menawarkan keseimbangan optimum antara keberkesanan kos dan peningkatan hasil.',
        'pdf_yield_projections': 'Unjuran Hasil 5 Tahun',
        'pdf_yield_projections_text': 'Analisis ramalan hasil menyediakan peta jalan terperinci untuk pertumbuhan mampan selama lima tahun akan datang. Unjuran ini berdasarkan senario pelaburan yang realistik dan mengambil kira variasi bermusim, keadaan pasaran, dan garis masa pelaksanaan. Ramalan menunjukkan potensi untuk peningkatan hasil yang ketara dengan pengurusan yang betul dan campur tangan yang disasarkan.',
        'pdf_implementation_strategy': 'Strategi Pelaksanaan',
        'pdf_implementation_strategy_text': 'Pelaksanaan yang berjaya bagi cadangan ini memerlukan pendekatan berperingkat, bermula dengan campur tangan keutamaan tinggi dan secara beransur-ansur berkembang kepada amalan pengurusan yang komprehensif. Pemantauan berkala dan pengurusan adaptif akan penting untuk mencapai hasil yang diunjurkan dan memastikan kelestarian jangka panjang.',
        'pdf_long_term_outlook': 'Prospek Jangka Panjang',
        'pdf_long_term_outlook_text': 'Analisis menunjukkan potensi yang kuat untuk peningkatan produktiviti yang berterusan dan peningkatan keuntungan. Dengan mengikuti strategi yang disyorkan dan mengekalkan amalan pemantauan yang konsisten, ladang anda boleh mencapai peningkatan hasil yang ketara sambil menyumbang kepada matlamat intensifikasi pertanian mampan. Unjuran 5 tahun menyediakan visi yang jelas untuk kejayaan jangka panjang dan pertumbuhan berterusan.',
        'pdf_final_summary': 'Ringkasan Akhir',
        'pdf_final_summary_text': 'Analisis ini menyediakan asas komprehensif untuk mengoptimumkan prestasi ladang kelapa sawit anda. Gabungan penilaian pemakanan terperinci, analisis ekonomi, dan unjuran hasil menawarkan laluan yang jelas ke hadapan untuk mencapai peningkatan produktiviti dan keuntungan. Pelaksanaan strategi yang disyorkan akan meletakkan ladang anda untuk kejayaan mampan dan pertumbuhan jangka panjang.',
        ...
        # Additional results page translations (Malaysian)
        'data_source': 'Sumber Data',
        'soil_analysis_report': 'Laporan Analisis Tanah',
        'leaf_analysis_report': 'Laporan Analisis Daun',
        'structured_ocr_data': 'Data OCR Berstruktur',
        'total_samples': 'Jumlah Sampel',
        'parameters_analyzed': 'Parameter Dianalisis',
        'report_type': 'Jenis Laporan',
        'extraction_status': 'Status Pengekstrakan',
        'success': 'Berjaya',
        'message': 'Mesej',
        'data_extracted_successfully': 'Data berjaya diekstrak',
        'number_of_samples': 'Bilangan Sampel',
        'results_data_keys': 'Kunci data hasil',
        'analysis_results_keys': 'Kunci hasil analisis',
        'raw_data_keys': 'Kunci data mentah',
        'soil_parameters_found': 'Parameter tanah ditemui',
        'leaf_parameters_found': 'Parameter daun ditemui',
        'comprehensive_analysis_keys': 'Kunci analisis komprehensif',
        ...
        'col_samples': 'Samples',
        'col_sample': 'Sample',
        'col_sample_no': 'Sample No.',
        'col_lab_no': 'Lab No.',
        'col_minimum': 'Minimum',
        'col_maximum': 'Maximum',
        'col_standard_deviation': 'Standard Deviation',
        'col_sample_count': 'Sample Count',

        # Additional results page translations
        'data_source': 'Data Source',
        'soil_analysis_report': 'Soil Analysis Report',
        'leaf_analysis_report': 'Leaf Analysis Report',
        'structured_ocr_data': 'Structured OCR Data',
        'total_samples': 'Jumlah Sampel',
        'parameters_analyzed': 'Parameter Dianalisis',
        'report_type': 'Jenis Laporan',
        'extraction_status': 'Status Pengekstrakan',
        ...
        # Data table column headers (Malaysian)
        'col_parameter': 'Parameter',
        'col_type': 'Jenis',
        'col_average': 'Purata',
        'col_min': 'Min',
        'col_max': 'Maks',
        'col_std_dev': 'Sisihan Piawai',
        'col_unit': 'Unit',
        'col_samples': 'Sampel',
        'col_sample': 'Sampel',
        'col_sample_no': 'No. Sampel',
        'col_lab_no': 'No. Makmal',
        'col_minimum': 'Minimum',
        ...
        'all_soil_sample_values': 'Semua Nilai Sampel Tanah',
        'leaf_analysis_summary': 'Ringkasan Analisis Daun',
        'all_leaf_sample_values': 'Semua Nilai Sampel Daun',
        ...
        'formatted_analysis': 'Analisis Terformat:',
