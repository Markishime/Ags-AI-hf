...
TRANSLATIONS = {
    'en': {
        ...
        'pdf_5_year_yield_projection_title': '5-Year Yield Projection from Current Baseline',
        'pdf_years': 'Years',
        'pdf_yield_tons_ha': 'Yield (tons/ha)',
        'pdf_current_baseline': 'Current Baseline',
        'pdf_high_investment': 'High Investment',
        'pdf_medium_investment': 'Medium Investment',
        'pdf_low_investment': 'Low Investment',
        'pdf_current': 'Current',
        'pdf_year_1': 'Year 1',
        'pdf_year_2': 'Year 2',
        'pdf_year_3': 'Year 3',
        'pdf_year_4': 'Year 4',
        'pdf_year_5': 'Year 5',
        'pdf_yield_projection_footnote': 'Projections assume continued yearly intervention with recommended nutrient management and stable market conditions.',
    ...
    'ms': {
        ...
        'pdf_5_year_yield_projection_title': 'Unjuran Hasil 5 Tahun dari Asas Semasa',
        'pdf_years': 'Tahun',
        'pdf_yield_tons_ha': 'Hasil (tan/ha)',
        'pdf_current_baseline': 'Asas Semasa',
        'pdf_high_investment': 'Pelaburan Tinggi',
        'pdf_medium_investment': 'Pelaburan Sederhana',
        'pdf_low_investment': 'Pelaburan Rendah',
        'pdf_current': 'Semasa',
        'pdf_year_1': 'Tahun 1',
        'pdf_year_2': 'Tahun 2',
        'pdf_year_3': 'Tahun 3',
        'pdf_year_4': 'Tahun 4',
        'pdf_year_5': 'Tahun 5',
        'pdf_yield_projection_footnote': 'Unjuran mengandaikan campur tangan tahunan yang berterusan dengan pengurusan nutrien yang disyorkan dan keadaan pasaran yang stabil.',
