...
TRANSLATIONS = {
    'en': {
        ...
        # Step Titles
        'step_1_title': 'Your Soil and Leaf Test Results and Analysis',
        'step_2_title': 'Diagnose Agronomic Issues',
        'step_3_title': 'Recommend Solutions',
        'step_4_title': 'Regenerative Agriculture Strategies',
        'step_5_title': 'Economic Impact Forecast',
        'step_6_title': 'Forecast Graph',
        
        # Step prefix for headers
        'step_prefix': 'STEP',
        ...
        'pdf_analysis_results': 'Analysis Results',
        'pdf_analysis_date': 'Analysis Date',
        'pdf_report_types': 'Report Types',
        'pdf_step_prefix': 'STEP',
        'pdf_step1_description': 'Data Analysis & Interpretation',
        'pdf_step2_description': 'Issue Diagnosis & Problem Identification',
        'pdf_step3_description': 'Solution Recommendations & Strategies',
        'pdf_step4_description': 'Regenerative Agriculture Integration',
        'pdf_step5_description': 'Economic Impact & ROI Analysis',
        'pdf_step6_description': 'Yield Forecast & Projections',
        'pdf_statistical_analysis': 'Statistical Analysis',
        'pdf_issues_identified': 'Issues Identified',
        'pdf_additional_recommendations': 'Additional Recommendations',
        'pdf_specific_recommendations_rates': 'Specific Recommendations (Rates)',
        'pdf_forecast_graph_title': 'Forecast Graph: 5-Year Yield Forecast & Projections',
        'pdf_5_year_yield_forecast_projections': '5-Year Yield Forecast & Projections',
        'pdf_5_year_yield_projection_baseline': '5-Year Yield Projection from Current Baseline',
        'pdf_5_year_yield_forecast': '5-Year Yield Forecast',
        'pdf_5_year_yield_forecast_baseline': '5-Year Yield Forecast from Current Baseline',
        'pdf_5_year_yield_forecast_sample': '5-Year Yield Forecast - Sample Projections',
        'pdf_5_year_yield_forecast_tonnes': '5-Year Yield Forecast (t/ha)',
        'pdf_5_year_yield_forecast_scenario': '5-Year Yield Forecast by Investment Scenario',
        'pdf_comprehensive_analysis_results': 'Comprehensive Analysis Results:',
        'pdf_summary': 'Summary',
        'pdf_detailed_analysis': 'Detailed Analysis',
        'pdf_data_tables': 'Data Tables',
    ...
    'ms': {
        ...
        'economic_summary': 'Ringkasan Ekonomi',
        ...
        'step_1_title': 'Keputusan Ujian Tanah dan Daun Anda dan Analisis',
        'step_2_title': 'Diagnosis Isu Agronomi',
        'step_3_title': 'Cadangan Penyelesaian',
        'step_4_title': 'Strategi Pertanian Regeneratif',
        'step_5_title': 'Ramalan Kesan Ekonomi',
        'step_6_title': 'Graf Ramalan',
        
        # Step prefix for headers (Malaysian)
        'step_prefix': 'LANGKAH',
        ...
        'pdf_analysis_results': 'Keputusan Analisis',
        'pdf_analysis_date': 'Tarikh Analisis',
        'pdf_report_types': 'Jenis Laporan',
        'pdf_step_prefix': 'LANGKAH',
        'pdf_step1_description': 'Analisis Data & Tafsiran',
        'pdf_step2_description': 'Diagnosis Isu & Pengenalan Masalah',
        'pdf_step3_description': 'Cadangan Penyelesaian & Strategi',
        'pdf_step4_description': 'Integrasi Pertanian Regeneratif',
        'pdf_step5_description': 'Kesan Ekonomi & Analisis ROI',
        'pdf_step6_description': 'Ramalan Hasil & Unjuran',
        'pdf_statistical_analysis': 'Analisis Statistik',
        'pdf_issues_identified': 'Isu yang Dikenal Pasti',
        'pdf_additional_recommendations': 'Cadangan Tambahan',
        'pdf_specific_recommendations_rates': 'Cadangan Khusus (Kadar)',
        'pdf_forecast_graph_title': 'Graf Ramalan: Ramalan & Unjuran Hasil 5 Tahun',
        'pdf_5_year_yield_forecast_projections': 'Ramalan & Unjuran Hasil 5 Tahun',
        'pdf_5_year_yield_projection_baseline': 'Unjuran Hasil 5 Tahun dari Garis Dasar Semasa',
        'pdf_5_year_yield_forecast': 'Ramalan Hasil 5 Tahun',
        'pdf_5_year_yield_forecast_baseline': 'Ramalan Hasil 5 Tahun dari Garis Dasar Semasa',
        'pdf_5_year_yield_forecast_sample': 'Ramalan Hasil 5 Tahun - Unjuran Sampel',
        'pdf_5_year_yield_forecast_tonnes': 'Ramalan Hasil 5 Tahun (t/ha)',
        'pdf_5_year_yield_forecast_scenario': 'Ramalan Hasil 5 Tahun mengikut Senario Pelaburan',
        'pdf_comprehensive_analysis_results': 'Keputusan Analisis Komprehensif:',
        'pdf_summary': 'Ringkasan',
        'pdf_detailed_analysis': 'Analisis Terperinci',
        'pdf_data_tables': 'Jadual Data',
        'pdf_parameter': 'Parameter',
        'pdf_value': 'Nilai',
        'pdf_unit': 'Unit',
        'pdf_status': 'Status',
