...
TRANSLATIONS = {
    'en': {
        ...
        'download_pdf_en': 'Download PDF Report (English)',
        'download_pdf_ms': 'Muat Turun Laporan PDF (Bahasa Malaysia)',
    ...
    'ms': {
        ...
        'download_pdf_en': 'Muat Turun Laporan PDF (Bahasa Inggeris)',
        'download_pdf_ms': 'Muat Turun Laporan PDF (Bahasa Malaysia)',
        ...
        'pdf_report_type_comprehensive': 'Jenis Laporan: Analisis Pertanian Menyeluruh',
        ...
        'pdf_generated_by': 'Dijana oleh Sistem Analisis AI AGS',
        'pdf_platform_name': 'Platform Kecerdasan Pertanian Lanjutan',
        'pdf_executive_summary': 'Ringkasan Eksekutif',
        'pdf_executive_summary_text': 'Analisis agronomi menyeluruh ini menilai parameter pemakanan utama dari kedua-dua sampel tanah dan tisu daun untuk menilai status kesuburan semasa dan kesihatan tanaman ladang kelapa sawit. Analisis ini berdasarkan pematuhan kepada piawaian Lembaga Minyak Sawit Malaysia (MPOB) untuk penanaman kelapa sawit yang optimum.',
        'pdf_parameters_analysis': 'Analisis Parameter',
        'pdf_parameters_summary': 'Analisis parameter termasuk penilaian nutrien tanah dan daun berdasarkan piawaian MPOB.',
